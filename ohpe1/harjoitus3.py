...
print("Ympyrän pinta-ala on: " + str(ympyränala))

#c) Suorakulmion pinta-ala
luku3 = input("Seuraavaksi ohjelma laskee suorakulmion pinta-alan. Syötä ensimmäisen sivun pituus: ")

luku4 = input("Syötä toisen sivun pituus: ")
